        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Mahasiswa</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Tambah Mahasiswa</h6>
            </nav>
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    <div class="col-6 d-flex align-items-center">
                                        <h6 class="mb-0">Form Tambah Mahasiswa</h6>
                                    </div>
                                ...
                                <div class="row">
                                    <form action="{{ route('mahasiswa.store') }}" method="POST">
                                        ...
                                        <div class="col-md-12 mb-md-0 mb-4">
                                          ...
                                          <input type="number" name="kode_pendaftar" class="form-control">
                                        </div>
                                        <div class="col-md-12 mb-md-0 mb-4">
                                        ...
                                        <div class="col-md-12 mb-md-0 mb-4">
                                          ...
                                          <option value="MANDIRI-S2">MANDIRI-S2</option>
                                          <option value="PRESTASI A">PRESTASI A</option>
                                          <option value="RPL PEROLEHAN SKS">RPL PEROLEHAN SKS</option>
                                          <option value="RPL TRANSFER SKS">RPL TRANSFER SKS</option>
                                        </select>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-md-0 mb-4">
                                          ...
                                          <select name="prodi_pilihan1" class="form-control">
                                            ...
                                            <option value="S1-S1 Manajemen">S1-S1 Manajemen</option>
                                            ...
                                            <option value="S2-S2 Manajemen">S2-S2 Manajemen</option>
                                          </select>
                                        </div>
                                        <div class="col-md-12 mb-md-0 mb-4">
