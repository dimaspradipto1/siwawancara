                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <br>
                                                <td>{{ $mahasiswa->kode_pendaftar }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">:</td>
                                                <br>
                                                <td>{{ $mahasiswa->jalur_pendaftar }}</td>
                                            </tr>
                                            <tr>
                                                <td>Sistem Kuliah</td>
                                                <td class="text-center">:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">:</td>
                                                <br>
                                                <td>{{ $mahasiswa->prodi_pilihan1 }}</td>
                                            </tr>
                                            <tr>
                                                <td>Prodi Pilihan 2</td>
                                                <td class="text-center">:</td>
                                                <br>
                                                <td>{{ $mahasiswa->prodi_pilihan2 }}</td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kelamin</td>
                                                <td class="text-center">:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">:</td>
                                                <br>
                                                <td>{{ $mahasiswa->status_pekerjaan }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
