...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <nav
        ...
        <div class="container">
            <img src="{{ asset('assets/img/logouis.png') }}" alt="logo" style="width: 70px; height: 70px;">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 ps-3 text-white" href="#">
                SIWAWANCARA
            </a>
            ...
            <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
              Pages
              <img src=" {{ asset('dashboard/assets/img/down-arrow-dark.svg') }}  " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src=" {{ asset('dashboard/assets/img/down-arrow-dark.svg') }} " alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
                  ...
                  <ul class="list-group">
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1" id="dropdownSignIn">
                        <span>Sign In</span>
                        <img src=" {{ asset('dashboard/assets/img/down-arrow.svg') }} " alt="down-arrow" class="arrow">
                      </a>
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
              ...
              <div class="row d-lg-none">
                ...
                {{-- <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="#" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1"
    ...
    <section class="min-vh-100 mb-8">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('{{ asset('assets/img/gedung.jpg') }}');">
