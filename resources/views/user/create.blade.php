                                ...
                                <div class="row">
                                    <form action="{{ route('user.store') }}" method="POST">
                                        ...
                                        <div class="col-md-6 mb-md-0 mb-4">
                                          ...
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="is_interviewer" id="is_interviewer" value="1">
                                            <label class="form-check-label" for="is_interviewer">Interviewer</label>
                                          </div>
                                      
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="is_timtes" id="is_timtes" value="1">
